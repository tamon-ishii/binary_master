...
def generate_c_header(
    ...
    """Generate a complete C99/C11 header file from a Builder or BinaryWriter instance."""
...
def write_c_header(
    ...
    """Generate C header code from a Builder and optionally save to file."""

...
| [`04_procedural_writer.py`](./04_procedural_writer.py) | Procedural Writer & Reader | Low-level stream writing, null-terminated/length-prefixed strings, alignment padding, and captions |

...
| [`06_advanced_v2_features.py`](./06_advanced_v2_features.py) | Advanced v0.2.0 Features | `Magic`, `Constant`, `BinaryEnum`, `CRC32` automated checksums, `VarUInt`/`VarInt` LEB128 variable-length integers, arbitrary `BitWriter`/`BitReader` |
